...
function Model() {
  ...
  const adjustCarForScreenSize = () => {
    ...
    if (window.innerWidth < 768) {
      screenScale = !inIframe ? [4.9, 4.9, 4.9] : [8.9, 8.9, 8.9]; //90% of full size of model
      screenPosition = [0, -6.5, -43]; // x,y,z axis positioning
    } else {
      screenScale = [7, 7, 7]; //full size of model
  ...
  return (
    <section className="w-full h-[100vh] relative bg-[black] z-10 overflow-hidden">
      <SideBar />
      <StatsCard />
      <Canvas
